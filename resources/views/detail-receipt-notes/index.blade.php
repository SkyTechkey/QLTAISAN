    ...
    <div class="modal fade" id="addAsset">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form  method="POST" action={{route('detail-receipt-note.store')}} enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group col-sm-4">
                            <input type="text" name="PN_id" class="form-control" value="{{$note_id}}" hidden>
                        </div>
                        <div class="row my-3">
                            <div class="col-sm-4">
                        ...
                        <div class="form-group my-3 row">
                            ...
                            <form  method="POST" action={{route('assets.create')}} enctype="multipart/form-data">
                                ...
                                <input type="text" name="detail_type" class="form-control" value="receipt" hidden>
                                ...
                                <div class="modal fade" id="editAsset{{ $detail->id }}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form  method="POST" action={{route('detail-receipt-note.update',$detail->id)}} enctype="multipart/form-data">
                                                        @csrf
                                                        @method('put')
                                                        <div class="card-body">
                                                            <div class="form-group col-sm-4">
                                ...
                                <div class="modal fade" id="deleteAsset{{ $detail->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    <form action="{{route('detail-receipt-note.destroy',$detail->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-header">
